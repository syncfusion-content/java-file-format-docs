...
N> Currently Essential DocIO supports the .DOCX, .DOTX, .DOTM, .DOCM, .WordML, .RTF, .Txt, WordML, HTML, Word2007, Word2010, Word2013 file formats only. Please refer the [supported and unsupported features](https://help.syncfusion.com/java-file-formats/word-library/supported-and-unsupported-features) in the essential DocIO.