...
N> Currently, Essential DocIO supports the .DOCX, .DOTX, .DOTM, .DOCM, .WordML, .RTF, .Txt, WordML, HTML. Please refer to the [supported and unsupported features](https://help.syncfusion.com/java-file-formats/word-library/supported-and-unsupported-features) in the essential DocIO.